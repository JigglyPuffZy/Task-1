  ...
  return (
    <header className="bg-white/90 dark:bg-gray-950/90 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-orange-100 dark:border-gray-800 transition-all">
      ...
      >
        ...
        <div
          className={`absolute right-0 top-0 h-screen w-full max-w-sm bg-white dark:bg-gray-950 shadow-2xl transform transition-transform duration-500 ease-in-out ${
        ...
        >
          ...
          <div className="p-6 space-y-4 border-t border-gray-200 dark:border-gray-800">
            ...
            >
              {darkMode ? (
                <>
                  <SunIcon size={20} className="text-orange-400" /> Light Mode
                </>
              ) : (
                <>
                  <MoonIcon size={20} className="text-gray-600" /> Dark Mode
                </>
              )}
            </button>
          </div>
